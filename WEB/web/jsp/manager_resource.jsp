                ...
                <div class="nav-box">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">电影资源</li>
                        </ol>
                    </nav>
                </div>
                <div class="main-box">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
<%--                                    <div class="btn-box">--%>
                                        <button type="button" class="btn btn-danger m-2" disabled style="float: right" onclick="allDelete('${pageContext.request.contextPath }/AdminServlet?method=deleteSelectResource');" id="allDelete">删除选中</button>
<%--                                    </div>--%>
...
<%--                                                <th scope="col">等级</th>--%>
                                            ...
                                            <c:forEach items="${pageInfo.resourceList}" var="resource">
                                                <tbody>
                                                <tr>
                                                    <th scope="row"><input type="checkbox" name="id" onclick="checkSelect(this);" value="${resource.id }"></th>
                                                    <td>${resource.id}</td>
                                                    <td>${resource.name}</td>
...
<%--                                                    <td>${resource.level}</td>--%>
                                                    <td>
                                                        <button type="button" class="btn btn-danger" onclick="btnClick(${resource.id },'${pageContext.request.contextPath }/AdminServlet?method=deleteResource&resourceID=${resource.id }')">删除</button>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </c:forEach>
                                        ...
                                        <nav class="mt-3">
                                            <ul class="pagination justify-content-end">
                                                ...
                                                <li class="page-item"><a class="page-link"
                                                                         href="${pageContext.request.contextPath }/AdminServlet?method=resourceManageJsp&currentPage=1">首页</a>
                                                </li>
                                                <li class="page-item"><a class="page-link"
                                                                         href="${pageContext.request.contextPath }/AdminServlet?method=resourceManageJsp&currentPage=${pageInfo.currentPage-1}">上一页</a>
                                                    </c:if>
                                                ...
                                                <c:if test="${pageInfo.currentPage ne status.index}">
                                                    <li class="page-item "><a class="page-link"
                                                                              href="${pageContext.request.contextPath }/AdminServlet?method=resourceManageJsp&currentPage=${status.index}"
                                                                              tabindex="-1" aria-disabled="true">${status.index}</a></li>
                                                </c:if>
                                                ...
                                                <c:if test="${pageInfo.currentPage < pageInfo.totalPages }">
                                                    <li class="page-item"><a class="page-link"
                                                                             href="${pageContext.request.contextPath }/AdminServlet?method=resourceManageJsp&currentPage=${pageInfo.currentPage+1}">下一页</a>
                                                    <li class="page-item"><a class="page-link"
                                                                             href="${pageContext.request.contextPath }/AdminServlet?method=resourceManageJsp&currentPage=${pageInfo.totalPages}">尾页</a>
                                                    </li>
                                                </c:if>
                                            </ul>
                                        </nav>
