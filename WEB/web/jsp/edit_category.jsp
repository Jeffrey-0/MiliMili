                ...
                <div class="nav-box">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">编辑电影类型</li>
                        </ol>
                    </nav>
                </div>
                <div class="form-box col-6">
                    <div class="row">
                        <div class="col-12 p-2">
                            <form action="${pageContext.request.contextPath }/AdminServlet?method=editCategory" class="m-2" method="POST">
                                <div class="form-group">
                                    <label for="aName">修改类型名称</label>
                                    <input type="text" class="form-control" placeholder="" name="aname" id="aName" value="${categoryName }">
                                </div>
