            ...
            <div class="container-fluid">
                ...
                <div class="btn-box">
                    <button type="button" class="btn btn-primary m-2"
                            onclick="window.open('${pageContext.request.contextPath }/AdminServlet?method=addAdminJsp','_self')">添加管理员</button>
                    <button type="button" class="btn btn-danger m-2" disabled
                            style="float: right"
                            onclick="allDelete('${pageContext.request.contextPath }/AdminServlet?method=deleteSelectAdmin');"
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                <th scope="col"><input type="checkbox"
                                                                       onclick="checkSelect(this);" id="selectAll"></th>
                                                <th scope="col">ID</th>
                                            ...
                                            <c:forEach items="${pageInfo.list }" var="admin">
                                                <tbody>
                                                <tr>
                                                    <th scope="row"><input type="checkbox" name="id" onclick="checkSelect(this);" value="${admin.id }"></th>
                                                    <td>${admin.id }</td>
                                                    <td>${admin.username }</td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger" onclick="btnClick(${admin.id },'${pageContext.request.contextPath }/AdminServlet?method=deleteAdmin&adminID=${admin.id }')">删除</button>
                                                        <button type="button" class="btn btn-success" onclick="window.open('${pageContext.request.contextPath }/AdminServlet?method=editAdminJsp&adminName=${admin.username }','_self')">编辑</button>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </c:forEach>
                                        ...
                                        <nav class="mt-3">
                                            <ul class="pagination justify-content-end">
                                                ...
                                                <li class="page-item"><a class="page-link"
                                                                         href="${pageContext.request.contextPath }/AdminServlet?method=adminManageJsp&currentPage=1">首页</a>
                                                </li>
                                                <li class="page-item"><a class="page-link"
                                                                         href="${pageContext.request.contextPath }/AdminServlet?method=adminManageJsp&currentPage=${pageInfo.currentPage-1}">上一页</a>
                                                    </c:if>
                                                ...
                                                <c:if test="${pageInfo.currentPage ne status.index}">
                                                    <li class="page-item "><a class="page-link"
                                                                              href="${pageContext.request.contextPath }/AdminServlet?method=adminManageJsp&currentPage=${status.index}"
                                                                              tabindex="-1" aria-disabled="true">${status.index}</a></li>
                                                </c:if>
                                                ...
                                                <c:if test="${pageInfo.currentPage < pageInfo.totalPages }">
                                                    <li class="page-item"><a class="page-link"
                                                                             href="${pageContext.request.contextPath }/AdminServlet?method=adminManageJsp&currentPage=${pageInfo.currentPage+1}">下一页</a>
                                                    <li class="page-item"><a class="page-link"
                                                                             href="${pageContext.request.contextPath }/AdminServlet?method=adminManageJsp&currentPage=${pageInfo.totalPages}">尾页</a>
                                                    </li>
                                                </c:if>
                                            </ul>
                                        </nav>
