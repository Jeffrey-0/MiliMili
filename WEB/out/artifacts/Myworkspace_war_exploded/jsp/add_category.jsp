                ...
                <div class="nav-box">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">添加视频类型</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="col-12 p-2">
                            <form class="m-2" id="form">
                                <div class="form-group">
                                    <label for="aName">类型名称</label> <input type="text" class="form-control" placeholder="" name="aname" id="aName">
                                </div>
                                <div class="form-group">
                                    <label for="descn">类型描述</label> <input type="text" class="form-control" placeholder="" name="descn" id="descn">
                                </div>
                                <a id="formBtn" class="btn btn-primary" href="javascript:" type="submit">添加</a>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    $('#formBtn').click(function () {
            $.ajax({
                type: "post",
                url: "AdminServlet?method=addCategory",
                data: $('#form').serialize(),
                dataType:"json",
