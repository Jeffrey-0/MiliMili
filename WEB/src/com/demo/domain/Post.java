...
public class Post {
    ...
    public Post(Integer id, Integer post_id, Integer post_stprey_id, Integer post_from_uid, String post_from_name, Integer post_to_uid, String post_to_name, String post_content, String post_date) {
        this.id = id;
        this.post_id = post_id;
        this.post_stprey_id = post_stprey_id;
        this.post_from_uid = post_from_uid;
